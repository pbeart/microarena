...
from .spike_vm.struct_tcp_mmio_proto import mmiotcp_message_header
        ...
        try:
            while True:
                ...
                if header.operation == ord("w"): # write operation, more data follows
                    ...
                    payload = b""
                    #print(f"Write operation t{time.time()%1000}, 0x{header.len:X} bytes @0x{header.addr:X}:")
